...
if (isset($_REQUEST['new'])) {
	...
	<td class="td1"><input type="text" class="checkdicturl notempty" name="LgDict1URI" value="glosbe_api.php?from=••&dest=••&phrase=###" maxlength="200" size="60" /> <img src="icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
	</tr>
	<tr>
	<td class="td1 right">Dictionary 2 URI:</td>
	<td class="td1"><input type="text" class="checkdicturl" name="LgDict2URI" value="" maxlength="200" size="60" /></td>
	</tr>
	<tr>
	<td class="td1 right backlightyellow">GoogleTranslate URI:</td>
	<td class="td1"><input type="text" class="checkdicturl" name="LgGoogleTranslateURI" value="*http://translate.google.com/?ie=UTF-8&sl=••&tl=••&text=###" maxlength="200" size="60" /></td>
	</tr>
	<tr>
...
elseif (isset($_REQUEST['chg'])) {
	...
	if ($record = mysql_fetch_assoc($res)) {
		...
		<td class="td1"><input type="text" class="notempty checkdicturl" name="LgDict1URI" value="<?php echo tohtml($record['LgDict1URI']); ?>"  maxlength="200" size="60" /> <img src="icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
		</tr>
		<tr>
		<td class="td1 right">Dictionary 2 URI:</td>
		<td class="td1"><input type="text" class="checkdicturl" name="LgDict2URI" value="<?php echo tohtml($record['LgDict2URI']); ?>"  maxlength="200" size="60" /></td>
		</tr>
		<tr>
		<td class="td1 right">GoogleTranslate URI:</td>
		<td class="td1"><input type="text" class="checkdicturl" name="LgGoogleTranslateURI" value="<?php echo tohtml($record['LgGoogleTranslateURI']); ?>" maxlength="200" size="60" /></td>
		</tr>
		<tr>
