...
{ 
    ...
    $rr = "";
    $r = 
    '<form action="" method="post"><table class="tab1" cellspacing="0" cellpadding="5">
        <tr>
    ...
    foreach ($items as $item) {
        ...
        if ($vals[0] > -1) {
            if ($nontermbuffer != '') {
                ...
                $r .= $nontermbuffer; 
                $r .= '</td>
                <td class="td1 right" colspan="3"><img class="click" src="icn/tick.png" title="Back to \'Display/Print Mode\'" alt="Back to \'Display/Print Mode\'" onclick="location.href=\'print_impr_text.php?text=' . $textid . '\';" />
                </td>
                </tr>';
                $nontermbuffer ='';
            }
