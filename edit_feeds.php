...
<tr><td class="td1">Options: </td><td class="td1"><table style="width:100%"><tr><td style="width:35%"><input type="checkbox" name="edit_text"<?php if(get_nf_option($row['NfOptions'],'edit_text')!==NULL)echo ' checked="checked"'; ?> /> Edit Text </td><td><input type="checkbox" name="c_autoupdate"<?php if($auto_upd_i!==NULL)echo ' checked="checked"'; ?> /> Auto Update Interval: <input class="posintnumber<?php if(get_nf_option($row['NfOptions'],'autoupdate')!==NULL)echo ' notempty'; ?>" data_info="Auto Update Interval" type="text" size="4" name="autoupdate" value="<?php echo $auto_upd_i . '"';if($auto_upd_i==NULL)echo ' disabled'; ?> />
...
<tr><td><input type="checkbox" name="c_max_links"<?php if(get_nf_option($row['NfOptions'],'max_links')!==NULL)echo ' checked="checked"'; ?> /> Max. Links: <input class="<?php if(get_nf_option($row['NfOptions'],'max_links')!==NULL)echo 'notempty '; ?>posintnumber maxint_300" data_info="Max. Links" type="text" size="4" name="max_links" value="<?php echo get_nf_option($row['NfOptions'],'max_links') . '"';if(get_nf_option($row['NfOptions'],'max_links')==NULL)echo ' disabled'; ?> /></td><td><input type="checkbox" name="c_charset"<?php if(get_nf_option($row['NfOptions'],'charset')!==NULL)echo ' checked="checked"'; ?> /> Charset: <input <?php if(get_nf_option($row['NfOptions'],'charset')!==NULL)echo 'class="notempty" '; ?>type="text" data_info="Charset" size="20" name="charset" value="<?php echo get_nf_option($row['NfOptions'],'charset') . '"';if(get_nf_option($row['NfOptions'],'charset')==NULL)echo ' disabled'; ?> /> </td></tr>
<tr><td><input type="checkbox" name="c_max_texts"<?php if(get_nf_option($row['NfOptions'],'max_texts')!==NULL)echo ' checked="checked"'; ?> /> Max. Texts: <input class="<?php if(get_nf_option($row['NfOptions'],'max_texts')!==NULL)echo 'notempty '; ?>posintnumber maxint_30" data_info="Max. Texts" type="text" size="4" name="max_texts" value="<?php echo get_nf_option($row['NfOptions'],'max_texts') . '"';if(get_nf_option($row['NfOptions'],'max_texts')==NULL)echo ' disabled'; ?> /></td><td><input type="checkbox" name="c_tag"<?php if(get_nf_option($row['NfOptions'],'tag')!==NULL)echo ' checked="checked"'; ?> /> Tag: <input <?php if(get_nf_option($row['NfOptions'],'tag')!==NULL)echo 'class="notempty" '; ?>type="text" data_info="Tag" size="20" name="tag" value="<?php echo get_nf_option($row['NfOptions'],'tag') . '"';if(get_nf_option($row['NfOptions'],'tag')==NULL)echo ' disabled'; ?> /> </td></tr>
<tr><td colspan="2"><input type="checkbox" name="c_article_source"<?php if(get_nf_option($row['NfOptions'],'article_source')!==NULL)echo ' checked="checked"'; ?> /> Article Source: <input class="<?php if(get_nf_option($row['NfOptions'],'article_source')!==NULL)echo 'notempty '; ?>" data_info="Article Source" type="text" size="20" name="article_source" value="<?php echo get_nf_option($row['NfOptions'],'article_source') . '"';if(get_nf_option($row['NfOptions'],'article_source')==NULL)echo ' disabled'; ?> /></td></tr></table>
</td></tr>
...
<?php
		$sql = 'select count(*) as value from ' . $tbpref . 'newsfeeds where '; if($currentlang>0)$sql .= 'NfLgID ='.$currentlang . $wh_query;else$sql .= '1=1' . $wh_query;
