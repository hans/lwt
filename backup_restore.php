...
<td class="td1">
<p><input type="submit" name="backup" value="Download LWT Backup" /></p>
</td>
</tr>
<tr>
...
<p><input type="submit" name="restore" value="Restore from LWT Backup" /></p>
<p class="smallgray">
Upload limits (in bytes): <b>post_max_size = <?php echo ini_get('post_max_size'); ?> / upload_max_filesize = <?php echo ini_get('upload_max_filesize'); ?></b><br />
