...
echo '.wsty:after{font-size:50%;margin-left: 0.2em;',($ann_exists?'':'overflow:hidden;white-space:nowrap;text-overflow:ellipsis;max-width:15em;display:inline-block;vertical-align:-25%;'),'}</style>';
