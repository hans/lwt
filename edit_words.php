...
while ($record = mysql_fetch_assoc($res)) {
	...
	echo '<td class="td1"><span id="trans' . $record['WoID'] . '" class="edit_area">' . tohtml(repl_tab_nl($record['WoTranslation'])) . '</span> <span class="smallgray2">' . tohtml($record['taglist']) . '</span></td>';
