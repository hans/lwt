...
echo '<img id="hidet" style="margin-bottom:-5px;" class="click" src="icn/light-bulb-T.png" title="Hide Text" alt="Hide Text" onclick="{$(\'#showt\').show(); $(\'#hidet\').hide(); $(\'.anntermruby\',window.parent.frames[\'text\'].document).css(\'color\',\'#E5E4E2\').css(\'background-color\',\'#E5E4E2\');}" />';
echo '<img id="showt" style="display:none; margin-bottom:-5px;" class="click" src="icn/light-bulb-off-T.png" title="Show Text" alt="Show Text" onclick="{$(\'#showt\').hide(); $(\'#hidet\').show(); $(\'.anntermruby\',window.parent.frames[\'text\'].document).css(\'color\',\'black\').css(\'background-color\',\'white\');}" />';
echo '<img id="hide" style="padding-right:30px; margin-bottom:-5px;" class="click" src="icn/light-bulb-A.png" title="Hide Annotation" alt="Hide Annotation" onclick="{$(\'#show\').show(); $(\'#hide\').hide(); $(\'.anntransruby2\',window.parent.frames[\'text\'].document).css(\'color\',\'#C8DCF0\').css(\'background-color\',\'#C8DCF0\');}" />';
echo '<img id="show" style="display:none; padding-right:30px; margin-bottom:-5px;" class="click" src="icn/light-bulb-off-A.png" title="Show Annotation" alt="Show Annotation" onclick="{$(\'#show\').hide(); $(\'#hide\').show(); $(\'.anntransruby2\',window.parent.frames[\'text\'].document).css(\'color\',\'#006699\').css(\'background-color\',\'white\');}" />';
echo tohtml($title);
